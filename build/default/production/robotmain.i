...
# 13 "robotmain.c" 2
# 1 "./../Common/initialize.h" 1
# 13 "./../Common/initialize.h"
# 1 "./../Common/pin_manager.h" 1
# 462 "./../Common/pin_manager.h"
...
void TMR2_PrescaleSet(uint8_t prescaleVal);
# 18 "robotmain.c" 2
# 1 "./../Common/uart1.h" 1
# 35 "./../Common/uart1.h"
typedef union {
...
# 20 "robotmain.c" 2
# 1 "./../Common/pololu_robot.h" 1
# 22 "./../Common/pololu_robot.h"
...
void Countdown(char time)
{
    ...
    TMR0_Initialize(0x9F & 0x90, 0x5F & 0xEF & 0xF8);
    TMR0_StartTimer();
    LCD_Position(0,1);
